...
class Daftar_model extends CI_Model {
	...
	public function listing_daftar($id_daftar = FALSE) {
	if ($id_daftar === FALSE)	{
		$query = $this->db->query('SELECT * FROM daftar ORDER BY id_daftar DESC');
	...
	public function delete($data) {
		...
		return $this->db->delete('daftar', $data);
	}
	
	// Listing data
	public function get_daftar($limit, $start) {
		$this->db->select('*');
		$this->db->from('daftar');
