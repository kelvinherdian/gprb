...
<label>Judul berita/profil</label>
<input type="text" name="judul_berita" class="form-control" placeholder="Judul berita/profil" required="required" value="<?php echo set_value('judul_berita') ?>">
</div>
...
<div class="form-group form-group-lg">
<label>Icon berita/profil</label>
<input type="text" name="icon" class="form-control" placeholder="Icon berita/profil" value="<?php echo set_value('icon') ?>">
</div>
...
<!-- Modal -->
<div class="modal fade" id="xxx" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
