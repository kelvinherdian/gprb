  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url('admin/akun') ?>" class="d-block"><?php echo $this->session->userdata('nama'); ?><br> (<?php echo $this->session->userdata('akses_level'); ?>)
          </a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>DAFTAR <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/daftar') ?>" class="nav-link"><i class="fa fa-sitemap nav-icon"></i><p>Data Daftar Lembaga</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/idv') ?>" class="nav-link"><i class="fa fa-sitemap nav-icon"></i><p>Data Daftar Individu</p></a>
              </li>
            </ul>
          </li>
