        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <?php } ?>
                    <li class="sub-active"><a href="<?php echo base_url('berita') ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Berita Lengkap</a></li>                   
                </ul>
            </li>
            ...
            <!-- DOWNLOAD -->
            <li><a target="_blank" href="<?php echo base_url('download') ?>">UNDUHAN</a></li>
            
            <!-- kontak  -->
            <li><a href="<?php echo base_url('kontak') ?>">KONTAK</a></li>
            <li><a href="<?php echo base_url('form') ?>">DAFTAR</a></li>
        </ul> <!--
