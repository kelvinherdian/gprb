...
<div class="kontakwa">
  <a href="https://wa.me/<?php echo str_replace('+','',$site->hp) ?>?text=ada yang ingin saya tanyakan, bisakah dibantu?" class="topbar-social-item"><i class="fa fa-whatsapp"></i>
        </a>
</div>
<!-- END WA -->
<?php 
            ...
            <div class="col-md-6 col-sm-6">
                <div class="footer-widgets">
                    <div class="widgets-title">
                        <h4 style="color:white;"><?php echo $site->tagline ?></h4>
                    </div>
...
<div class="row">
    <div class="footer-bottom">
        <div class="copyright-txt">
            <p>&copy; <?php echo date('Y') ?>.  <a href="http://bnpb.go.id" title="Badan Nasional Penangulangan Bencana">BNPB</a></p>
        </div>
        <!-- .copyright-txt -->
